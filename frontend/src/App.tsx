...
import HistorySurvey from './page/interviewee/HistorySurveyPage';
import UserProfilePage from './page/interviewee/UserProfilePage';
import ResetPasswordPage from './page/ResetPasswordPage';
import MngSurvey from './page/interviewer/MngSurveyPage';
import MngSurveyReview from './page/interviewer/MngSurveyReviewPage';
import SurveyResponseAnalytics from './page/interviewer/SurveyResponseAnalyticsPage';
import PaymentResultPage from './page/interviewer/PaymentResultPage';
import ServicePackage from './page/interviewer/ServicePackagePage';
import CreateSurveys from './page/interviewer/CreateSurveysPage';
import ViewSurvey from './page/interviewee/ViewSurveyPage';
