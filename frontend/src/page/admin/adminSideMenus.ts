...
import { FiBarChart2, FiCreditCard, FiFolder, FiGrid, FiMessageSquare, FiUsers } from 'react-icons/fi';

export type AdminSideMenuKey = 'dashboard' | 'users' | 'surveys' | 'billing' | 'categories' | 'quality';
...
export const adminSideMenus: AdminSideMenuItem[] = [
  ...
  { key: 'billing', label: 'Gói & Thanh toán', icon: FiCreditCard, path: '/dashboard-admin/billing' },
